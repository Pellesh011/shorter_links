...
This module handles SQLite database operations without using any ORM.
"""
...
class Database:
    ...
    def _get_connection(self) -> sqlite3.Connection:
        ...
        For file-based databases, this creates a new connection each time.
        For in-memory databases (":memory:"), this reuses the same connection
        within the same instance to maintain data across operations.
